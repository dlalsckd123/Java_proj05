...
public class UncheckedException {
	...
	public static void main(String[] args) {
		// 실행 예외 : 컴파일 단계에서 체크 하지 않는다. 실행시 예외가 발생됨
		...
		//B b = (B) a;	//a 객체는 B타입을 포함 하지 않는다, 실행시 문제 발생
		
		//3. ArrayIndexOutofBoundException
		int [] arr = new int[] {1,2,3};
		System.out.println(arr[3]);  //배열의 방의 벙호를 넘김.
		
		//4. NumberFormatException : 문자타입의 정수(int), 실수(double) 변환예외
