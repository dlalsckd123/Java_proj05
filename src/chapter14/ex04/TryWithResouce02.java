...
public class TryWithResouce02 {

	public static void main(String[] args) {
		// try withj Resource : java 1.7
		//일반적인 try 구문 : try {} catch (Exception e) {}
			//try (객체선언[Resource] ) {} catch (Exception e) {}
			//자동으로 객체를 close()
			//자동으로 객체를 제거하기 위해서는 AutoCloseble() 인터페이스를 구현 클래스만이 자동으로 제거됨
		
		//1. 자동으로 객체를 제거하는 예제
			//(Resource : 객체를 선언)	< == 객체를 자동으로 close() 하게 된다.
			//InputStreamReader 는 AutoCloseble 인터페이스를 구현하고 있다.
