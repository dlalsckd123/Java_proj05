...
class Tiger extends Animal{
	//자식 클래스의 생정자에는 기본적으로 super()가 생략되어 있다.
...
public class MethodOverriding_test {
	...
	public static void main(String[] args) {
		// 메소드 오버라이딩 : 상속 관계에서 부모클래스의 메소드를 자식 클래스에서 재 정의
		...
		// T1은 Animal, Tiger 를 내포 하고 있고, Tiger 타입으로 지정(Animal, Tiger 접근)
		Tiger t1 = new Tiger();
		//부모의 필드와 메소드 호출
		t1.name="호랑이1";
		t1.age = 5;
		...
		//다운 캐스팅 : a2 : Animal, Tiger 을 내포하고 있고 Animal 타입
		Tiger t2 = (Tiger) a2;	//다운캐스팅 할때는 반드시 instanceof를 사용을 해야 한다.
