...
public class ArrayListMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println(aList2); 	//1, 2, 3, 6, 4, 6
		...
		//7. remove(Object o) : 방이 들어간 값으로 삭제
		...
		Integer[] int1 = aList3.toArray(new Integer[0]);	
			//0 : 변환할 배열방의 갯수인데, 컬렉션의 배열 방보다 작게 설정된경우 컬렉션에 저장된 갯수에 맞추어서 처리됨
