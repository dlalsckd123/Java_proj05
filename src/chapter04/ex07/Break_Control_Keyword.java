...
public class Break_Control_Keyword {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<10; i++) {
			System.out.println(i);
			if(i==5) {		//if조건을 사용해서 조건이 만족 되었을때 탈출
				break;
			}
		}//0,1,2,3,4,5
		System.out.println("============================");
		//2. 다중9이중) loop 문에서 break 탈출
		// case 1 : 하나의 반복문만 탈출하는 경우
		 ...
		 System.out.println("========LABLE을 사용해서 한번에 LABLE 위치로 점프=======");
		// case 2 : 점프해서 한번에 for 문을 탈출 (LABLE)
		pos1: for (int i=0; i<5; i++) { //pos1: 아래있는 브레이크에서 위쪽 pos1까지 바져나가라
			 for (int j=0; j<5; j++) {
				if(j==2) {
		...
		System.out.println("======================================");
		// case 2 : 점프해서 한번에 for 문을 탈출 (변수 값을 조정해서 탈출)
