...
public class If_Controll_Statement {
	...
	public static void main(String[] args) {
		...
		if(value1 < 3 ) {
			//조건이 참일때 실행블락
			System.out.println("실행1"); //조건이 거짓이므로 실행되지 않음
		}
		System.out.println("========{조건이 참일때 실행문}, {} 생략 가능 =======");
			//if 조건에서 실행문이 하나일때 {} 생략이 가능하다.
		if (value1 < 3)  
		...
		// if (조건1) {조건 1이 참일때 실행} 
		//else if (조건2) { 초건 2가 참일때 실행 } .. 
		//else if (조건2) { 초건 2가 참일때 실행 } .. 
		//........
		// else {조건에 존재하지 않는경우 실행}		
	
		int value3 = 40;
		if( value3 > 90) {
			System.out.println("A 학점");
		}else if (value3 >= 80) {
			System.out.println("B 학점"); //if문을 빠져나온다. 실행후 탈ㅊ출
		}else if (value3 >= 70) {
