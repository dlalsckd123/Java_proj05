...
public class Array_Definition {
	...
	public static void main(String[] args) {
		...
		//int[] : 정수 값만 배열에 저장 가능
		//array1 : 배열 변수, array1 변수 명은 Stack 공간에 저장이되고, array1 에 Heap 영역의 주소 값이 저장
	...
	System.out.println("============= 배열 : 1. 선언 방법3 =================");
	...
	System.out.println("============= 배열 : 1. 선언 방법4 =================");
