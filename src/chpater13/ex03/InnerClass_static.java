package chpater13.ex03;

/*
  	static Inner Class : 외부클래스에서 인스턴스필드, 인스턴스 멧드는 static Inner Class 블락에 올 수 없다.
  			//외부 클래스의 정적 필드, 정적 메소드만 static Inner Class 블락에 올 수 있다.
  			  
  			인스턴스 필드, 인스턴스 메소드 객체 생성후 사용 가능
  			정적 필드, 정적 메소드 메소드는 객체 생성 없이 사용가능, 객체 생성이후에도 사용 가능
 */
