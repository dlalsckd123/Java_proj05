...
class A {	//Outer class : 필드, 메소드에 접근 제어가 붙어 있고, 
	...
	private int d = 6;		//다른패키지, 같은패키지에서도 접근 불가능, 같은 클래스에서만 접근 
	
	void abc () {
		System.out.println("A 클래스의 메소드 abc() 입니다.");
	}
	//이너 클래스 : 인스턴스 이너클래스, 1. 아웃터 클래스의 접근제어자와 상관없이 접근, 
...
public class InnerClass01 {
	...
	public static void main(String[] args) {
		...
		A.B b = a.new B();	//A, B : 외부클래스.내부클래스 : A.B : 내부 클래스의 타입.
							//b : 참조 변수
							//a.new B();	<== 외부인스턴스명.new 내부클래스 생성자호출;
		b.bcd();
