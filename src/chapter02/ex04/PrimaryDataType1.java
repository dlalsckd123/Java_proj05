	...
	public static void main(String[] args) {
		...
		System.out.println(value6);
		  ...
		  //long : 8byte = 64bit : -2^63 ~ 2^63-1
			//long 의 변수에 값을 할당 할때는, l, L을 붙여줘야한다.
			// 붙여주지 않으면 기본적으로 int 형으로 값이 저장됨
		
		long value7 = -100L;
		System.out.println(value7);
		
		// 3. 실수 (float : 정밀도 소숫점 이하 7자리(4byte), double : 정밀도 소숫점 이하 15자리(8byte))
		   // 실수의 기본은 double
		
		   // float : float 으로 지정된 변수의 값을 할당 할때 리터럴에 f, F 명시해야한다.
		float value8 = 1.123456789F; 
		System.out.println(value8); //1.1234568 로 출력?
		
		double value9 = 1.12345678910111213; //1.1234567891011122 로 출력?
		System.out.println(value9);
		
		// 4. 문자 (char) : 영문/한글/일본어/중국어/...., 숫자, 특수문자 한 글자 
		   //변수의 값을 할당할 리터럴에 ' '
				//1. char 자료형 변수에 직접 문자로 저장하는 방법 (
		char value10 = 'A';  //AA를 넣을시 오류남, 한글자만 출력 가능
		char value11 = 'a';
		char value12 = '가'; 
		char value13 = '3';
		char value14 = '#';
		...
		char value15 = 65;	//A
		char value16 = 0xac00; //0x - 16진수, 0 - 8진수, 0b - 2진수  // 가
		char value17 = 51; //3
		...
		/*
		 * <문제> 구글을 검색해서 자신의 이름의 유닠코드를 찾아서 변수에 할당
		 */
		char aa = '\uc774'; //성
		char bb = '\uBBFC'; //이름1
		char cc = '\uCC3D'; //이름2
		
		System.out.print(aa); //이
		System.out.print(bb); //민
		System.out.print(cc + "\n"); //창
